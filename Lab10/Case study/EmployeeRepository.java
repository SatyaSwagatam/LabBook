...
public class EmployeeRepository {
	...
	public static void main(String[] args) {
		...
		set.add(new Employee(1234, "Satya", "Panda", "satyaswagatam@gmail.com", "9122341234", LocalDate.now(), "Manager", 126000.0, 1111,buss));
		set.add(new Employee(2234, "Preetam", "Tripathy", "prtmtripathy@gmail.com", "9922222525", LocalDate.now(), "Analyst", 30000.0, 2222, fin));
		set.add(new Employee(5234, "Amit", "Rout", "routamit007@gmail.com", "8250456525", LocalDate.now(), "SDE", 80000.0, 3333, it));
		set.add(new Employee(7234, "Abhilash", "S", "a@gmail.com", "6055456525", LocalDate.now(), "SDE2", 160000.0, 4444, it));
